(function() {
    ...
    window.onload = function(e) {
        ...
        function loadDataFromJson() {
            $.getJSON("json/productJson.json", function(json) {
                ...
                for (var key in skuJSON) {
                    ...
                    if (skuJSON.hasOwnProperty(key)) {
                        for (var p = 0; p < skuJSON[key].length; p++) {
                            ...
                            imageElementInsideDiv.src = "images/" + key + "/" + (p + 1) + ".jpg";
                ...
                for (var i = 0; i < slideContainer.length; i++) {
                    ...
                    gestureVar.addEventListener("mouseover", function(e) {
                        mouseOverVar = e.target.parentElement.parentElement.id;
                    });
                    ...
                    hammerDetect.on("swipeleft", function(ev) {
                        ...
                        if (mouseOverVar == ev.target.parentElement.parentElement.id) {
                ...
                initialTween.staggerFrom(".section-title", .4, { y: 30, opacity: 0 }, .2)
                    .from(".tout-copy", .4, { y: 30, opacity: 0 })
                    .from("#tutorial-on", .4, { y: 30, opacity: 0 });


                instructionTween = new TimelineLite({ paused: true });
        ...
        function animateSlides(newMode, currentParent) {
            ...
            TweenLite.fromTo("#shopLink", 0.3, { x: -1 }, { x: 1, ease: RoughEase.ease.config({ strength: 8, points: 20, template: Linear.easeNone, randomize: false }), clearProps: "x" })
